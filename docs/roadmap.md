...
- Assistentes internos para revisão, tags e resumo.

## Critério de Evolução

Novas funcionalidades devem respeitar três critérios:

- reforçar a identidade editorial;
- melhorar a experiência de leitura ou publicação;
- não comprometer performance e manutenção.
